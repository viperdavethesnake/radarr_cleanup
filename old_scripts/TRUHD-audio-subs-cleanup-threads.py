...
source_dir = "./"
cleaned_dir = "/cleaned"  # NFS Mounted Path on macOS
notruehd_dir = "./notruehd"  # Local directory for non-compliant files
...
def process_mkv(file):
    ...
    try:
        ...
        if video_track is None or truehd_audio_track is None:
            ...
            return f"{filename} moved to {notruehd_dir} (no A_TRUEHD audio)."
